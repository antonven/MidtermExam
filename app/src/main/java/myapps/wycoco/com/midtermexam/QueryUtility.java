...
public class QueryUtility {
    ...
    public static ArrayList<AlbumsModel> fetchAlbumData(String requestUrl, int requestCode){
    ...
    private static ArrayList<AlbumsModel> extractFeatureFromJson(String albumJson){
        ...
        try{
            ...
            for (int i = 0; i < secondArray.length(); i++) {
                ...
                AlbumsModel album = new AlbumsModel(name, artist, url, image);
                albums.add(album);
            }
    ...
    private static ArrayList<AlbumsModel> extractFeatureFromJson2(String albumJson){
        if(TextUtils.isEmpty(albumJson)){
            return null;
        }
